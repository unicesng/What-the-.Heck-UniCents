...
const cardsData = [
  {
    ...
    description: "Analyze expenses among different colleges for potential university students and grasp the specific financial aid options suited to the qualifications of each individual user.",
  ...
  },
  {
    ...
    description: "Connect with university students all over the world and learn the tips and trick to save up money while studying!",
